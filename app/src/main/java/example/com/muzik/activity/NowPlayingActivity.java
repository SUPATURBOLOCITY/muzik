package example.com.muzik.activity;
...
import example.com.muzik.utils.Utilities;

import static example.com.muzik.activity.MainActivity.ARTIST_NAME;
import static example.com.muzik.activity.MainActivity.ITEM_POSITION;
...
public class NowPlayingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private final Runnable updateTimeTask = new Runnable() {
        ...
        public void run() {
            if (mediaPlayer != null) {
                ...
                totalTimeTextView.setText(String.valueOf(Utilities.millisecondsToTimer(totalDuration)));
                currentTimeTextView.setText(String.valueOf(Utilities.millisecondsToTimer(currentDuration)));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalTimeTextView.setText(Utilities.getDuration(this, musicItem.getSongId()));
