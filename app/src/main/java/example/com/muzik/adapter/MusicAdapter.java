...
import example.com.muzik.activity.NowPlayingActivity;
import example.com.muzik.data.MusicItem;
import example.com.muzik.activity.MainActivity;
        ...
        if (holder.play != null) {
            holder.play.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(MainActivity.ITEM_POSITION, holder.getAdapterPosition());
