...
import example.com.muzik.fragment.ArtistsFragment;
...
public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.ArtistItemHolder> {
    ...
    private ArtistsFragment.OnItemSelectedListener listener;

    public ArtistAdapter(Context context, ArrayList<MusicItem> artistList, ArtistsFragment.OnItemSelectedListener listener) {
